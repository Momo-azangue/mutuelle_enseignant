...
<div class="container mt-5 mb-5">
    ...
    <div class="row mb-2">
        <div class="col-12 white-block">
            <h3 class="text-center text-muted">Cotisation aux quelles contribuer</h3>
            <hr>
    ...
    <div class="row">
        <div class="col-12 white-block">
            <h3 class="text-center text-muted">Cotisation totalement contribuées</h3>
            <hr>
                            ...
                            <div class="card card-image" style="background-image: url(<?= \app\managers\FileManager::loadAvatar($user,'512') ?>);">
                                ...
                                <div class="text-white text-center justify-content-center align-items-center rgba-black-strong py-5 px-4">
                                    <div>
                                        ...
                                        <a class="btn btn-primary" href="<?= Yii::getAlias("@administrator.help_details")."?q=".$tontine->id ?>"><i class="fas fa-clone left"></i> Details</a>
                                    </div>
                                </div>
                            </div>
                            <!-- Card -->
            ...
            <?php
                ...
                <h6 class="text-center mt-2">Aucune Tontine repertoriée</h6>
            <?php
            endif;
            ?>
        </div>
