...
<div>
    ...
    <br>
    En effet, votre collègue <?= $target->first_name." ".$target->name ?> nécessite une aide de type <span style="color: dodgerblue">"<?=$tontineType->title?>"</span>.
    Ainsi une somme de <span class="amount"><?= $unit?$unit:0 ?> XAF</span> est attendu de votre part avant le <b><?= (new DateTime($tontine->limit_date))->format("d-m-Y") ?></b>
</div>